package br.com.bb.progWeb_mvcSistemaBancarioGradle.service;
...
import br.com.bb.progWeb_mvcSistemaBancarioGradle.model.dao.ContaCorrenteDAO;
...
public class ContaCorrenteService {
	...
	public void update(ContaCorrente cc) {
		...
		ccToUpdate.get().setVariação(cc.getVariação());
	}

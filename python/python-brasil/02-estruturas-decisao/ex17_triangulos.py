...
informar se os valores podem ser um triângulo. Indique, caso os lados formem um triângulo, se o mesmo é:
...
# Programa já realizado no exercício 35 do Curso em Vídeo do Gustavo Guanabara
